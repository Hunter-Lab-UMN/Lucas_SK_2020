...
```{r}
enrich <- subset_samples(ps, grepl("enrichment", PROJECT, ignore.case = TRUE) & # just keep sample pairs from enrichments
...
metadata$ENRICH_PUB_LETTER <- factor(metadata$ENRICH_PUB_LETTER, levels = c("A","B","C","D","E","F","G"))
