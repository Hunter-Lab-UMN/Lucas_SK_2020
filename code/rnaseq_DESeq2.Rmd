...
makeMA <- function(x){
  p <- ggmaplot(x, 
                ...
                fdr = 0.05, fc = 2, size = 2, alpha = 0.8,
...
```
```{r include = FALSE}
ggsave(maPlot234, filename = "rnaseq_output/maplot243vsMMMG.pdf", height=5, width=7)
ggsave(maPlot243, filename = "rnaseq_output/maplot234vsMMMG.pdf", height=5, width=7)
ggsave(maPlot262, filename = "rnaseq_output/maplot262vsMMMG.pdf", height=5, width=7)
```
